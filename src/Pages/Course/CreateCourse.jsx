    ...
    <HomeLayout>
            <div className="flex justify-center items-center h-[100vh] mb-10">
                ...
                <Link className="absolute top-5 text-2xl link text-accent cursor-pointer ">
                    ...
                    <button type="submit" className="w-full text-xl font-semibold bg-yellow-600 hover:bg-yellow-500 py-2 rounded-lg cursor-pointer transition-all ease-in-out duration-300">
                        Create course
                    </button>
                </form>
            </div>
